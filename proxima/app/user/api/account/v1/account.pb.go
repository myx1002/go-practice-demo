...
func (x *UserRegisterRes) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_account_v1_account_proto_rawDesc = "" +
	...
	"\vUserInfoRes\x12#\n" +
	"\x04user\x18\x01 \x01(\v2\x0f.pbentity.UsersR\x04user2\xd2\x01\n" +
	"\aAccount\x12H\n" +
	"\fUserRegister\x12\x1b.account.v1.UserRegisterReq\x1a\x1b.account.v1.UserRegisterRes\x12?\n" +
	"\tUserLogin\x12\x18.account.v1.UserLoginReq\x1a\x18.account.v1.UserLoginRes\x12<\n" +
	"\bUserInfo\x12\x17.account.v1.UserInfoReq\x1a\x17.account.v1.UserInfoResB!Z\x1fproxima/app/user/api/account/v1b\x06proto3"
