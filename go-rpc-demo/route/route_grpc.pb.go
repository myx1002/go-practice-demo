...
const (
	RouteGuide_GetFeature_FullMethodName   = "/route.RouteGuide/GetFeature"
	RouteGuide_ListFeatures_FullMethodName = "/route.RouteGuide/ListFeatures"
	RouteGuide_RecordRoute_FullMethodName  = "/route.RouteGuide/RecordRoute"
	RouteGuide_Recommend_FullMethodName    = "/route.RouteGuide/Recommend"
)
...
func (c *routeGuideClient) Recommend(ctx context.Context, opts ...grpc.CallOption) (RouteGuide_RecommendClient, error) {
	stream, err := c.cc.NewStream(ctx, &RouteGuide_ServiceDesc.Streams[2], RouteGuide_Recommend_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
