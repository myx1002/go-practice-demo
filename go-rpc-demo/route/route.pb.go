...
func (x *Point) GetLatitude() int64 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *Point) GetLongitude() int64 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
type RouteSummary struct {
	...
	PointCount  int64 `protobuf:"varint,1,opt,name=point_count,json=pointCount,proto3" json:"point_count,omitempty"`    // 一共经过多少个点
	Distance    int64 `protobuf:"varint,2,opt,name=distance,proto3" json:"distance,omitempty"`                          // 走了多少距离
	ElapsedTime int64 `protobuf:"varint,3,opt,name=elapsed_time,json=elapsedTime,proto3" json:"elapsed_time,omitempty"` // 花费了多少时间
}
...
func (x *RouteSummary) GetPointCount() int64 {
	if x != nil {
		return x.PointCount
	}
	return 0
...
func (x *RouteSummary) GetDistance() int64 {
	if x != nil {
		return x.Distance
	}
	return 0
...
func (x *RouteSummary) GetElapsedTime() int64 {
	if x != nil {
...
var file_route_proto_rawDesc = []byte{
	...
	0x08, 0x6c, 0x61, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x08, 0x6c, 0x61, 0x74, 0x69, 0x74, 0x75, 0x64, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x6c, 0x6f, 0x6e,
	0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6c, 0x6f,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x67, 0x6f, 0x2d, 0x72,
	0x70, 0x63, 0x2d, 0x64, 0x65, 0x6d, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
