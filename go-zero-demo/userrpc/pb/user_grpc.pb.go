...
const (
	UserInfo_GetUserInfo_FullMethodName = "/pb.UserInfo/GetUserInfo"
)
...
func (c *userInfoClient) GetUserInfo(ctx context.Context, in *GetUserInfoReq, opts ...grpc.CallOption) (*GetUserInfoResp, error) {
...
func (UnimplementedUserInfoServer) GetUserInfo(context.Context, *GetUserInfoReq) (*GetUserInfoResp, error) {
